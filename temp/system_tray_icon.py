# Based on: Simon Brunning - simon@brunningonline.net and Mark Hammond's win32gui_taskbar.py and win32gui_menu.py demos from PyWin32
    ...
    def _add_ids_to_menu_options(self, menu_options):
        ...
        for menu_option in menu_options:
            ...
            if callable(option_action) or option_action in self.SPECIAL_ACTIONS:
                ...
                print()
                'Unknown item', option_text, option_icon, option_action
